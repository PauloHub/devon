                                ...
                                <form action="{{ url('/edit_employee', $employee->ID) }}" method="POST">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                <label>RG</label>
                                                <input type="text" class="form-control" placeholder="RG" name="FUNC_RG" value="{{$employee->FUNC_RG}}" >
                                            </div>
                                        </div>
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                <label>CPF</label>
                                                <input type="text" class="form-control" placeholder="CPF" name="FUNC_CPF" value="{{$employee->FUNC_CPF}}" >
                                            </div>
                                        </div>
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                <label>Conta</label>
                                                <input type="text" class="form-control" placeholder="Conta" name="FUNC_CONTA" value="{{$employee->FUNC_CONTA}}" >
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="Telefone" name="FUNC_TEL" value="{{$employee->FUNC_TEL}}" >
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                <label>Cargo</label>
                                                <input type="text" class="form-control"  placeholder="Cargo" name="FUNC_CARGO" value="{{$employee->FUNC_CARGO}}" >
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
