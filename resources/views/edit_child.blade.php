                                        ...
                                        <div class="row">  
                                         <div class="col-md-5">
                                            <ul>                                                   
                                                ...
                                                ?>
                                                @foreach($tipo_documentos as $tipo_documento_1)   
                                                <?php $cont_repeticao=0; ?>    

                                                @if($tipo_documento_1->TPDO_ID <= 10 )
                                                ...
                                                <li style="list-style-type:none;">  
                                                    ...
                                                    @if($tipo_documento_1->TPDO_ID ==  $tipo_documento[$i]->TPDO_ID )
                                                    <li style="list-style-type:none;">          
                                                        <label class="checkbox-inline"><input type="checkbox" name="FK_TPDO_ID[]" value="{{ $tipo_documento[$i]->TPDO_ID }}" checked/>{{ $tipo_documento[$i]->TPDO_DESC}}</label>
                                                    </li>
                                                    <?php $cont_repeticao++; ?> 
                                                    @endif
                                                    @endfor
                                                    @if($cont_repeticao==0)            
                                                    <label class="checkbox-inline"><input type="checkbox"  name="FK_TPDO_ID[]" value="{{ $tipo_documento_1->TPDO_ID }}"/>{{ $tipo_documento_1->TPDO_DESC }}</label>
                                                </li>
                                                @endif
                                                @endif
                                                @if($flag == $dividir)
                                ...
                                <div class="form-group">  
                                    ...
                                    <div class="col-md-5">
                                        <ul>                                                   
                                            ...
                                            $dividir = $count_doc % 2 == 0 ? $count_doc/2 : ($count_doc/2) + 0.5;
                                            ?>
                                            @foreach($tipo_documentos as $tipo_documento_2)   
                                            <?php $cont_repeticao=0; ?>    

                                            @if($tipo_documento_2->TPDO_ID > 10 )
                                            ...
                                            <li style="list-style-type:none;">  
                                                ...
                                                @if($tipo_documento_2->TPDO_ID ==  $tipo_documento2[$i]->TPDO_ID )
                                                <li style="list-style-type:none;">          
                                                    <label class="checkbox-inline"><input type="checkbox" name="FK_TPDO_ID[]" value="{{ $tipo_documento2[$i]->TPDO_ID }}" checked/>{{ $tipo_documento2[$i]->TPDO_DESC}}</label>
                                                </li>
                                                <?php $cont_repeticao++; ?> 
                                                @endif
                                                @endfor
                                                @if($cont_repeticao==0)            
                                                <label class="checkbox-inline"><input type="checkbox"  name="FK_TPDO_ID[]" value="{{ $tipo_documento_2->TPDO_ID }}"/>{{ $tipo_documento_2->TPDO_DESC }}</label>
                                            </li>
                                            @endif
                                            @endif
                                            @if($flag == $dividir)
