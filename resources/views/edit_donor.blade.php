                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="content">
                                ...
                                <form action="{{ url('/edit_donor', $donor->ID) }}" method="POST">
                                    {{csrf_field()}}
                                    {!! method_field('PUT') !!}
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="Nome Completo" name="DOAD_NOME" value="{{$donor->DOAD_NOME}}" required>
                                            </div>
                                        </div>
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                <label>CPF</label>
                                                <input type="text" class="form-control" placeholder="CPF" name="DOAD_CPF" maxlength="11" value="{{$donor->DOAD_CPF}}" required>
                                            </div>
                                        </div>
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                <label>Telefone 1</label>
                                                <input type="text" class="form-control" placeholder="Telefone" name="DOAD_TEL_1" maxlength="15" value="{{$donor->DOAD_TEL_1}}" required>
                                            </div>
                                        </div>
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                <label>Telefone 2</label>
                                                <input type="text" class="form-control" placeholder="Telefone" name="DOAD_TEL_2" maxlength="15" value="{{$donor->DOAD_TEL_2}}">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="email" class="form-control" placeholder="Email" name="DOAD_EMAIL" value="{{$donor->DOAD_EMAIL}}" required>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label>Bairro</label>
                                                <input type="text" class="form-control" placeholder="Bairro" name="DOAD_BAIRRO" value="{{$donor->DOAD_BAIRRO}}" required>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-10">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="Endereço"  name="DOAD_ENDE" value="{{$donor->DOAD_ENDE}}" required>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                <label>CEP</label>
                                                <input type="text" class="form-control" placeholder="CEP" name="DOAD_CEP" maxlength="8" value="{{$donor->DOAD_CEP}}" required>
                                            </div>
                                        </div>
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                <label>Número</label>
                                                <input type="number" class="form-control" placeholder="Número da Casa" name="DOAD_NUMERO_CASA" value="{{$donor->DOAD_NUMERO_CASA}}" required>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-10">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="Endereço"  name="DOAD_OBS" value="{{$donor->DOAD_OBS}}">
                                            </div>
                                        </div>
                                    </div>
