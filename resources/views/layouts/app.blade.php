        ...
        <nav class="navbar navbar-default navbar-static-top" style="position:absolute; width: 100%;">
            <div class="container">
                <div class="navbar-header">
                    ...
                    <!-- Branding Image -->
                    <a class="navbar-brand" href="{{ url('/home') }}" style=" max-width: 100%; height: auto; margin-left: -130px; margin-top: -20px; position:absolute;"> <img src="img/logo.png" width="210px">
