                                ...
                                <form>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="Nome Completo" name="DOAD_NOME" value="<?php echo e($donor->DOAD_NOME); ?>" disabled>
                                            </div>
                                        </div>
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                <label>CPF</label>
                                                <input type="text" class="form-control" placeholder="CPF" name="DOAD_CPF" maxlength="11" value="<?php echo e($donor->DOAD_CPF); ?>" disabled>
                                            </div>
                                        </div>
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                <label>Telefone 1</label>
                                                <input type="text" class="form-control" placeholder="Telefone" name="DOAD_TEL_1" maxlength="15" value="<?php echo e($donor->DOAD_TEL_1); ?>" disabled>
                                            </div>
                                        </div>
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                <label>Telefone 2</label>
                                                <input type="text" class="form-control" placeholder="Telefone" name="DOAD_TEL_2" maxlength="15" value="<?php echo e($donor->DOAD_TEL_2); ?>" disabled>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="email" class="form-control" placeholder="Email" name="DOAD_EMAIL" value="<?php echo e($donor->DOAD_EMAIL); ?>" disabled>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label>Bairro</label>
                                                <input type="text" class="form-control" placeholder="Bairro" name="DOAD_BAIRRO" value="<?php echo e($donor->DOAD_BAIRRO); ?>" disabled>
                                            </div>
                                        </div>
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                <label>Quant. de Doação</label>
                                                <input type="int" class="form-control" name="DOAD_QUANT_DOAC" value="<?php echo e($donor->DOAD_QUANT_DOAC); ?>" disabled>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-10">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="Endereço"  name="DOAD_ENDE" value="<?php echo e($donor->DOAD_ENDE); ?>" disabled>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                <label>CEP</label>
                                                <input type="text" class="form-control" placeholder="CEP" name="DOAD_CEP" maxlength="8" value="<?php echo e($donor->DOAD_CEP); ?>" disabled>
                                            </div>
                                        </div>
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                <label>Número</label>
                                                <input type="number" class="form-control" placeholder="Número da Casa" name="DOAD_NUMERO_CASA" value="<?php echo e($donor->DOAD_NUMERO_CASA); ?>" disabled>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-10">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="Endereço"  name="DOAD_OBS" value="<?php echo e($donor->DOAD_OBS); ?>" disabled>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <br><br>
                                        <div align="center">
                                            ...
                                            <a href="<?php echo e(url('/edit_donor', $donor->ID)); ?>" class="btn btn-info btn-fill">
