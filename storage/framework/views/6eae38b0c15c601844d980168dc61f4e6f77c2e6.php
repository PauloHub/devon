                                    ...
                                    <table class="table table-hover table-striped">
                                         ...
                                         <?php $__currentLoopData = $donors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $donor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>                                                    
                                            <tbody>                                               
                                                 ...
                                                 <td style="padding-left:2%; width: 70%";><?php echo e($donor->DOAD_NOME); ?></td>
                                                 <td><a href="<?php echo e(url('/show_donor', $donor->ID)); ?>" > <i class="fa fa-eye" aria-hidden="true" style="margin-left:19%;"></i></a></td>
                                                 <td><a href="<?php echo e(url('/edit_donor', $donor->ID)); ?>" > <i class="fa fa-pencil-square-o" aria-hidden="true" style="margin-left:19%;"></i></a></td>
                                            </tr>
                                            </tbody>
